        ...
        <div className={styles.createForm}>
          ...
          <div className={styles.formSection}>
            ...
            <div className={styles.formRow}>
              <select
                value={offerType}
                onChange={(e) => setOfferType(e.target.value as 'resource' | 'hero')}
              >
          ...
          <div className={styles.formSection}>
            ...
            <div className={styles.formRow}>
              <select
                value={requestType}
                onChange={(e) => setRequestType(e.target.value as 'resource' | 'hero')}
              >
                <option value="resource">Resource</option>
                <option value="hero">Hero</option>
              </select>
          ...
          <div className={styles.formActions}>
            ...
            <button onClick={() => setShowCreate(false)} className={styles.cancelButton}>
              Cancel
            </button>
          </div>
        </div>
