...
export const newTroopHeroes: Hero[] = [
  createHero(
    ...
    'Range +1',
    'Rain of Arrows: Deal 80% damage to all enemies',
    'Eagle Eye: Crit Rate +10%',
    'Elite elven archer.',
  ),
  createHero(
    'cavalry_1',
    ...
    'Speed +20%',
    'Charge: Deal 200% damage to single target',
    "Knight's Honor: Defense +15%",
    'Legendary knight.',
  ),
  createHero(
    'mage_1',
    ...
    'Magic DMG +20%',
    'Fireball: Deal 150% magic damage',
    'Mana Flow: Cooldown -1s',
    'Grand wizard.',
  ),
  createHero(
    'flying_1',
    ...
    'Ignore Terrain',
    'Aerial Strike: Deal 120% damage',
    'Evasion: 10% chance to dodge',
    'Sky patrol.',
  ),
  createHero(
    'siege_1',
    ...
    'Structure DMG +50%',
    'Smash: Deal 180% damage',
    'Thick Skin: Damage Reduction +10%',
    'Living siege engine.',
  ),
  createHero(
    'infantry_1',
    ...
    'Defense +20%',
    'Excalibur: Deal 250% damage',
    "King's Aura: All Allies Defense +10%",
    'King of Camelot.',
  ),
];
