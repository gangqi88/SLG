...
export const WALL_HERO: Hero = {
  ...
  starRating: 1,
  equipment: [],
  talent: { id: 't_wall', name: 'Fortification', description: 'Reduces damage taken', type: 'Talent' },
...
export const STREET_FIGHT_DEFENDERS: Hero[] = [
    {
        ...
        activeSkill: { id: 's_slash', name: 'Slash', description: 'Deal damage', type: 'Active', cooldown: 5 },
    ...
    },
    {
        ...
        activeSkill: { id: 's_shot', name: 'Power Shot', description: 'Deal damage', type: 'Active', cooldown: 6 },
