...
- 中高风险改动必须验证特性开关行为
- 发布验证必须包含灰度阶段观测项：错误率、延迟、关键业务成功率
- 涉及接口或数据结构改动时必须包含契约测试
- 发布前必须验证回滚路径；不可逆场景必须验证前向恢复方案
...
_技能版本: 1.1.0_
_最后更新: 2026-03-17_
_相关文档: fullstack-code-standards/SKILL.md, task-scheduler/SKILL.md, .trae/rules/project-rules/R6-change-safety.md_
