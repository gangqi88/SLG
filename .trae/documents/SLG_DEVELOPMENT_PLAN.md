...
本项目是在《文明火种》末日生存模拟经营游戏基础上，扩展SLG英雄策略系统。保留原有生存模拟核心，同时融入英雄收集、阵营对抗、战斗策略等SLG元素。
...
├── components/SLG/HeroCultivation/
│   ├── HeroCultivationPanel.tsx  # 英雄养成面板 ✅
│   └── HeroCultivationPanel.css  # 养成面板样式 ✅
├── components/SLG/City/
│   ├── CityPanel.tsx            # 城池面板 ✅
│   └── CityPanel.css            # 城池面板样式 ✅
├── systems/
│   ├── HeroSystem.ts            # 英雄系统 ✅
...
│   ├── CitySystem.ts            # 城池系统 ✅
│   ├── TeamSystem.ts            # 队伍系统 ✅
│   ├── MatchSystem.ts           # PvP匹配系统 ✅
│   ├── AllianceSystem.ts        # 联盟系统 ✅
│   └── SeasonSystem.ts          # 赛季系统 ✅
├── types/slg/
│   ├── hero.types.ts            # 英雄类型 ✅
│   ├── city.types.ts           # 城池类型 ✅
│   └── multiplayer.types.ts     # 多人对战类型 ✅
└── data/
    └── heroes.ts              # 英雄配置数据 🔄
```
