...
- [ ] Design Tokens are defined and used consistently in styles.
- [ ] Unit tests (Vitest) pass with >90% coverage for critical logic.
- [ ] E2E tests (Cypress) pass for critical user flows (Login -> City).
- [ ] Performance metrics (Lighthouse) show improvements (LCP, TBT).
- [ ] `OPTIMIZATION_REPORT.md` is generated and complete.
